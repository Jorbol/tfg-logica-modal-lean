...
\usepackage{setspace}
\setstretch{1.15}
\usepackage[english,spanish,es-noshorthands,es-noindentfirst]{babel}
...
\lstdefinelanguage{lean}{
  keywords={import, inductive, structure, where, def, theorem, example,
            ...
            by, with, deriving, open, namespace, end, noncomputable, abbrev},
  keywords=[2]{intro, intros, exact, apply, have, constructor, rfl,
            ...
            absurd, trivial, assumption, rw, omega, decide},
  sensitive=true,
  comment=[l]{--},
  morecomment=[s]{/-}{-/},
  literate=
...
\lstnewenvironment{leansnippet}{\lstset{numbers=none}}{}
\usepackage{etoolbox}
\BeforeBeginEnvironment{lstlisting}{\par\noindent\begin{minipage}{\linewidth}}
\AfterEndEnvironment{lstlisting}{\end{minipage}\par}
\BeforeBeginEnvironment{leansnippet}{\par\noindent\begin{minipage}{\linewidth}}
\AfterEndEnvironment{leansnippet}{\end{minipage}\par}
\newcommand{\tactica}[1]{\paragraph{#1.}}
...
\newcommand{\lean}[1]{\mbox{\texttt{\small #1}}}\usepackage{microtype}
...
\newcommand{\simdif}{\mathbin{\triangle}}   % diferencia simétrica

...
\textbf{El código Lean íntegro junto con el código LaTeX de esta memoria se pueden encontrar en el siguiente repositorio: \url{https://github.com/Jorbol/tfg-logica-modal-lean} }